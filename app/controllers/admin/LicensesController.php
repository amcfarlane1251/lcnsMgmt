...
class LicensesController extends AdminController
{
    ...
    **/
    ...
    public function getClone($licenseId = null)
    {
        ...
        return View::make('backend/licenses/edit')->with('license_options',$license_options)->with('depreciation_list',$depreciation_list)->with('license',$license)->with('maintained_list',$maintained_list);
    ...
    **/
    ...
    public function getDatatable() {
        ...
        ->addColumn('role', function($licenses){
            if($licenses->role){
                return '<a href="roles/'.$licenses->role->id.'/view" title="'.$licenses->role->role.'">
                        '.$licenses->role->role.'</a>';
            }
        })
