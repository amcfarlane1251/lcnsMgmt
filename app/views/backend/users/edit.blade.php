        ...
        <div class="tab-pane active" id="tab-general">
         ...
         <div class="row form-wrapper">
            ...
            <div class="form-group {{ $errors->has('ec') ? 'has-error' : '' }}">
                ...
                <div class="col-md-7">
                    {{ Form::select('role_id', $ec, Input::old('role_id', $user->role_id), array('class'=>'select2', 'style'=>'width:250px')) }}
            ...
            <div class="form-group {{ $errors->has('lcnsTypes') ? 'has-error' : '' }}">
                ...
                <div class="col-md-5">
                   <div class="controls">
                        {{ Form::select('lcnsTypes[]', $lcnsTypes, $user->licenseTypes()->lists('id'), array('class'=>'select2', 'style'=>'width:240px', 'multiple'=>'multiple')) }}
                    </div>
                </div>
            </div>
